	...
	pub fn flush(&mut self) {
		...
		self.writer.begin_elem("borders");
			self.writer.begin_elem("border");
				self.writer.begin_elem("left"); self.writer.end_elem();
				self.writer.begin_elem("right"); self.writer.end_elem();
				self.writer.begin_elem("top"); self.writer.end_elem();
				self.writer.begin_elem("bottom"); self.writer.end_elem();
				self.writer.begin_elem("diagonal"); self.writer.end_elem();
			self.writer.end_elem();
		self.writer.end_elem();
